...
# Type checking (requires manual dependency installation)
...
### Local Development
1. Run `npm install` (never cancel, takes 45-60 seconds)
...
npm run astro check # Optional type checking
```
...
npm run preview    # Test built site functionality
